...
import { LocationOn, Warning, CalendarToday, CheckCircle, Cancel, Pending, AccessTime } from "@mui/icons-material";
...
export default function IncidentDetailPage() {
  ...
  const ttl = formatTTL(data.createdAt);
          ...
          <Box sx={{ display: "flex", alignItems: "center", gap: 3, flexWrap: "wrap" }}>
            ...
            <Box sx={{ flex: 1 }}>
              ...
              <Typography variant="h6" sx={{ opacity: 0.9, fontWeight: 400 }}>
                Детали инцидента #{data.id.slice(0, 8)}
              </Typography>
            </Box>
            <ShareButton
                ...
                <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
                  ...
                  <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
                    ...
                    <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                      ...
                      <Chip
                        label={ttl.text}
                        color={ttl.expired ? "error" : "default"}
                        sx={{ ml: "auto" }}
                      />
                    </Box>
